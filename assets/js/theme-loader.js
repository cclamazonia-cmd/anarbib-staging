(function () {
  ...
  function applyBrandAssets(assets) {
    ...
    const pageBackground = assets.backgroundPage || assets.background || assets.bgImage || '';
    const panelBackground = assets.backgroundPanel || assets.panelBackground || pageBackground;

    if (pageBackground) {
      setCssVar('--brand-bg-image', `url("${pageBackground}")`);
    }

    if (panelBackground) {
      setCssVar('--brand-panel-bg-image', `url("${panelBackground}")`);
    }
    ...
    setCssVar('--brand-panel-bg-position', assets.panelBackgroundPosition || assets.backgroundPosition || 'center center');
    setCssVar('--brand-panel-bg-size', assets.panelBackgroundSize || assets.backgroundSize || 'cover');
    setCssVar('--brand-panel-bg-repeat', assets.panelBackgroundRepeat || assets.backgroundRepeat || 'no-repeat');
